source("D:/Code/MF/BMF-main/R/Example/data_gen.R")
...
# Load the data
y_full <- read.csv("D:/Code/MF/BMF-main/R/data1.csv")
# load(paste("y_full_test-", index, ".dat", sep=''))
# y_full <- y_full
# data_mod_full <- y_full[vec1,]
data <- y_full[,1:(nobs + 1)]
# data_mod <- as.matrix(data_mod_full)[,1:(nobs + 1)]
