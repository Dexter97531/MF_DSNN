...
out <- lapply(variables,get_alfred_series,observation_start="1959-04-01",
              observation_end="2024-12-01",realtime_start="2024-12-01",realtime_end="2024-12-01")#Q2 1959 to Q3 2019
...
write.csv(data_full,"D:/Code/MF/BMF-main/R/data1_2024.csv")
